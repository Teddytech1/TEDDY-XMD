...
module.exports = { 
    ...
    FOOTER : process.env.FOOTER || 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝚃𝙴𝙳𝙳𝚈 ᴛᴇᴄʜ',
    CAPTION : process.env.CAPTION || '©𝟐𝟎𝟐5 TEDDY-XMD ',
    ...
    YT: process.env.YT || 'youtube.com/@Teddytech4',
    ...
    PACK_NAME: process.env.PACK_NAME || 'TEDDY ',
    PACK_AUTHOR: process.env.PACK_AUTHOR || 'TEDDY-TECH'
};
