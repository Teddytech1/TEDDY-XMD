...
if (conf.AUTOREACT_STATUS=== "yes") {
    zk.ev.on("messages.upsert", async (m) => {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '254799963583';
            const dj2 = '254799963583';
            const dj3 = "254799963583";
            const luffy = '254799963583';
    ...
    for (const { key, update } of chatUpdate) {
        ...
        if (update.protocolMessage && update.protocolMessage.type === 0) {
            ...
            try {
                ...
                let report = `*🚨 TEDDY ANTI-DELETE DETECTED 🚨*\n\n`;
            ...
            await zk.sendMessage(origineMessage, { 
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: "Alita Protection System",
                        serverMessageId: 1
                    }
                }
            });
        ...
        if (isBotAdmin && !isSenderAdmin) {
            ...
            await zk.sendMessage(origineMessage, { 
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: channelJid,
                        newsletterName: "Teddy Protection System",
                        serverMessageId: 1
                    }
                }
            });
         ...
         console.log("lien detecté")
            var verifZokAdmin = verifGroupe ? admins.includes(idBot) : false;
             if(superUser || verifAdmin || !verifZokAdmin  ) { console.log('je fais rien'); return};
                                    ...
                                    const gifLink = "https://raw.githubusercontent.com/Teddytech1/TEDDY-XMD/main/media/remover.gif";
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("------------------/-----");
                console.log("👀 Teddy is Online 🕸\n\n");
                
                console.log("🛒 Loading Alita Plugins...\n");
                fs.readdirSync(__dirname + "/teddytech").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            require(__dirname + "/teddytech/" + fichier);
                            console.log(fichier + "🛒🔑 Alita plugins Installed Successfully✔️");
                        }
                        catch (e) {
